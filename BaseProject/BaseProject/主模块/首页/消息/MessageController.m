...
//    _listTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    ...
    _listTableView.estimatedRowHeight = kScreenWidth;
    _listTableView.estimatedSectionFooterHeight = 0;
    _listTableView.estimatedSectionHeaderHeight = 0;
    _listTableView.delegate = self;
    _listTableView.dataSource = self;
    [_listTableView registerNib:[UINib nibWithNibName:@"MessageCell" bundle:[NSBundle mainBundle]]
...
- (void)loadListAction:(BOOL)isfooter {
    ...
    [NetTool loadNewsList:currentPage List:^(id  _Nonnull object) {
