...
- (void)addScrollView {
    ...
    self.bottomLineView.backgroundColor = [UIColor colorWithRed:238/255.0 green:238/255.0 blue:238/255.0 alpha:1];
    self.bottomLineView.frame = CGRectMake(0, height-1, SCREEN_WIDTH, 1);
...
- (void)calculateItemFrames {
    ...
    self.bottomLineView.jk_width = contentWidth;
}
